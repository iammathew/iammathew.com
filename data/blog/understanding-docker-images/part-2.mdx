---
title: Understanding Docker Images - Part 2
author: iammathew
tags: ['docker', 'oci', 'best practices']
date: '2021-11-27'
draft: true
summary: Bring your docker images to the next level by understanding how a docker image works under the hood and what we can learn from that to build better images.
...
<div>
  <img src="/static/images/docker-overlay.jpeg" title="OverlayFS" alt="OverlayFS" />
</div>
